function[] = lcf_exp_it_noperf(newiter,premium_diff,premiumstr_diff,variscens_lcf_it_noperf,fixedscens_lcf_it_noperf,notes_noperf)
...
%     end
   ...
   stem = sprintf('lcf_it_noperfdiffpremI%dP%sFS%dVS%d%s.mat',iteration-1,premiumstr_diff,fixedscens_lcf_it_noperf,variscens_lcf_it_noperf,notes_noperf);
...
if iteration == 1
    ...
    %%% run SOL-IT iter 1 and save soln info
    tic
...
slsfcomplong_new_lcf_it_noperf = zeros(m,n*trials); %save the base fixed compensation used for slsf
...
stem = sprintf('lcf_it_noperfdiffpremI%dP%sFS%dVS%d%s.mat',iteration,premiumstr_diff,fixedscens_lcf_it_noperf,variscens_lcf_it_noperf,notes_noperf);
