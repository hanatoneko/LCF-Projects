function[] = lcf_exp_it_bestperf(iteration_max,premium_diff,premiumstr_diff,variscens_lcf_it_bestperf,fixedscens_lcf_it_bestperf,notes_bestperf)
...
stem = sprintf('lcf_it_noperfdiffpremI%dP%sFS%dVS%d%s.mat',iteration_max,premiumstr_diff,fixedscens_lcf_it_bestperf,variscens_lcf_it_bestperf,notes_bestperf);
...
stem = sprintf('lcf_it_bestperfdiffpremmaxI%dP%sFS%dVS%d%s.mat',iteration_max,premiumstr_diff,fixedscens_lcf_it_bestperf,variscens_lcf_it_bestperf,notes_bestperf);
