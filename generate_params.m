function[C,D,r,q,yprobs,Oi,Di,Oj,Dj,drand]=generate_params(m,n,center)
...
%%% consolidated into just C)

%%% inputs: m=number of requests, n= number of drivers, center=1 if we are using the 'city center' i.e.
%%% chicago proper. For all of our testing, center=1.
...
%%% yprobs is the pij array, Oj/Oi is drivers'/riders' origin nodes (column vectors),
%%% Dj/Di are destinations (column vectors), drand is the column vecor random component
...
if center==1
    ...
    [arcdata,dem]=loadchicago_regional();
end
