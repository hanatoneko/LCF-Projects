function[obj,v2,x2,y2,w2,z2]=initial_bilevel(C,D,r,a,U,Sorted,theta)
addpath(genpath('C:\Users\hanna\OneDrive\Documents\MATLAB\yalmip'));

%%% I believe this is just the very first version of my formulation and the
%%% first thing I coded up for this project

[m,n]=size(C);
[q,n]=size(U);
N=q-m;
%Options=sdpsettings('solver','gurobi','bilevel.outersolver','gurobi','gurobi.TimeLimit',LCTL,...
 %   'bilevel.algorithm','external','kkt.dualbounds',0,'savesolveroutput',1);
