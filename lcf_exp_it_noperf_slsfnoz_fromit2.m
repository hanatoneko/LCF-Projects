function[] = lcf_exp_it_noperf_slsfnoz_fromit2(newiter,premium_diff,premiumstr_diff,variscens_lcf_it_noperf,fixedscens_lcf_it_noperf,notes_noperf)
...
%     end
   ...
   stem = sprintf('lcf_it_noperf_slsfnoz_fromit2I%dP%sFS%dVS%d%s.mat',iteration-1,premiumstr_diff,fixedscens_lcf_it_noperf,variscens_lcf_it_noperf,notes_noperf);
...
if iteration == 1
    ...
    runtimes_slsf_total_lcf_it_noperf = zeros(1,trials); %slsf runtime across iters
    ...
    testrejave_mini_slsf = zeros(1,trials); %average number of unmatched requests in the small performance tests
    ...
    runtimes_full_total_lcf_it_noperf = zeros(1,trials); %runtime of all components of SOL-IT through current iteration, including iteration 1 SLSF soln time etc
    ...
    runtimes_full_total_lcf_it_noperf = runtimes_slsf + runtimes_mini_slsf + (fixedscens_lcf_it_noperf/100)*runtimes_scens_lcfinput + runtimes_lcf_it_noperf + runtimes_mini_lcf_it_noperf;
...
runtimes_slsf_lcf_it_noperf = zeros(1,trials); %slsf runtime of current iter
...
for t = 1:trials
    ...
    runtimes_slsf_total_lcf_it_noperf(1,t) = runtimes_slsf_total_lcf_it_noperf(1,t) + toc;
...
runtimes_full_total_lcf_it_noperf = runtimes_full_total_lcf_it_noperf + runtimes_slsf_lcf_it_noperf + runtimes_lcf_it_noperf + runtimes_mini_lcf_it_noperf;

end

%%% save all active variables from this iteration into matlab data file 
stem = sprintf('lcf_it_noperf_slsfnoz_fromit2I%dP%sFS%dVS%d%s.mat',iteration,premiumstr_diff,fixedscens_lcf_it_noperf,variscens_lcf_it_noperf,notes_noperf);
