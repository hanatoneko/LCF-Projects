%%% not used in paper, not complete code. Started as a deterministice
%%% (single-scenario) verison that's iterative 

%%% this code, for each problem instance, solves each of the deterministic heuristic methods (fix5, vari5)
%%% and does performance analysis on each of those solutions, then
%%% a matlab data file is created saving all matlab variables, the file
%%% title is 'lcf_exp_detheur1' plus any other notes in the notes string,
%%% The variables for each experiment end with the experiment name (e.g. _fix1) , and 
