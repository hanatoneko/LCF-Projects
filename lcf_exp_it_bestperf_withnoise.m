function[] = lcf_exp_it_bestperf_withnoise(iteration_max,premium_diff,premiumstr_diff,variscens_lcf_it_bestperf,fixedscens_lcf_it_bestperf,noise,noisestr,notes_bestperf)
...
%%% best soln variables
    ...
    noise_lcf_it_bestperf = rand(size(p_best_lcf_it_bestperf)); %noise matrix
...
stem = sprintf('lcf_it_bestperfwithnoisemaxI%dP%sFS%dVS%dN%s%s.mat',iteration_max,premiumstr_diff,fixedscens_lcf_it_bestperf,variscens_lcf_it_bestperf,noisestr,notes_bestperf);
