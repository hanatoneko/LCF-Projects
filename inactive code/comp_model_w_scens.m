function[obj,gap,x,v,w,y,p,ptrue,u,psi]=comp_model_w_scens(Chat,theta,lwr,q,s,fyhat,fare,alpha,beta,buffer,mincomp,timelim,gap,displ)
%%% this code shouldn't be used so here's a line to make it crash if
%%% accidentally used
t==2
[m,n]=size(Chat);
...
objf(vfind,1)=repmat(Chat(:)-alpha(:),sfixed,1);
